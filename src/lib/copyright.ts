 ...
 *
 * @param value 4자리 연도 문자열(예: "1999"). null/undefined 허용
 ...
 *
 * @param publishYear 발행년도 원본 문자열(예: "20080401", "2008-04-01")
 * @returns 파싱된 연도 또는 null
 */
export function extractPublishYear(
  publishYear: string | null | undefined,
): number | null {
 ...
 * - 그 외 authorType: null
 *
 * @param authorType 저작자 유형('개인' | '단체' 등)
 * @param deathYear 몰년(4자리 문자열 예상)
 * @param publishYear 발행년도 원본 문자열(앞 4자리 사용)
